...
-- returns:
-- { was_dropped: TRUE }
DROP FUNCTION IF EXISTS fetchq_doc_drop_queue(CHARACTER VARYING);
CREATE OR REPLACE FUNCTION fetchq_doc_drop_queue (
	PAR_queue VARCHAR,
...
BEGIN
	...
	-- drop indexes
	-- PERFORM fetchq_doc_drop_queue_indexes(PAR_queue);
